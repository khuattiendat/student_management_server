...
exports.BulkAttendanceDto = exports.AttendanceStudentItemDto = void 0;
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
const attendance_entity_1 = require("../../../database/entities/attendance.entity");
class AttendanceStudentItemDto {
    studentId;
    status;
    rate;
}
...
], AttendanceStudentItemDto.prototype, "studentId", void 0);
__decorate([
    (0, class_validator_1.IsEnum)(attendance_entity_1.AttendanceStatus),
    __metadata("design:type", String)
], AttendanceStudentItemDto.prototype, "status", void 0);
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.ArrayUnique)((item) => item.studentId),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => AttendanceStudentItemDto),
    __metadata("design:type", Array)
], BulkAttendanceDto.prototype, "attendances", void 0);
